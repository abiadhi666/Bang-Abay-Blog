...
@foreach ($data as $post)
    <div id="post-header" class="page-header" style="margin-left: 15px; margin-right: -15px">
        <div class="page-header-bg" style="background-image: url('{{asset($post->image)}}');" data-stellar-background-ratio="0.5"></div>
        <div class="container">
            <div class="row">
				<div class="col-md-10">
				...
				<div class="col-md-8">
					...
					<div class="section-row">
						<div class="section-title">
							<h3 class="title">About <a href="author.html">{{$post->users->name}}</a></h3>
						</div>
